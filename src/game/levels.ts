...
export const levels: Level[] = [
  {
    ...
    localized: { ar: { title: " الوسط", subtitle: "ميدو يريد المقعد صاحب أقوى إضاءة." } },
    difficulty: 1,
    seats: row("seat", 3),
  ...
  },
  {
    ...
    localized: { ar: { title: " النافذة", subtitle: "نورا تحتاج إطلالة لتحديقها العاطفي." } },
    difficulty: 1,
    seats: row("seat", 3),
  ...
  },
  {
    ...
    localized: { ar: { title: " الأصدقاء", subtitle: "بوبو يحتاج مشجعًا قريبًا على بعد همسة." } },
    difficulty: 2,
    seats: row("seat", 4),
  ...
  },
  {
    ...
    localized: { ar: { title: " يسار الباص", subtitle: "جيجي تقول إن زاوية التصوير تنجح فقط من اليسار." } },
    difficulty: 2,
    seats: row("seat", 4),
